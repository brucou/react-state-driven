...
import {getEventEmitterAdapter, logError, tryCatch} from "./helpers";
...
export class Machine extends Component {
  ...
  componentDidMount() {
    ...
    // initial event is optional. Use it for instance if you want to pass data with the event
    ...
    const initialEvent = options && options.initialEvent || {[MOUNTED]: void 0};
    // `debug` is optional. As of now, includes the console to log debugging info
